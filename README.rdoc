...
The currently available, latest release of the plugin is version <b>0.4.0</b>.
...
This plugin has been tested on Redmine 2.1.x, 2.3.x, 2.4.x, 3.0.x, 3.1.x and 3.2.x.
...
* (C) 2013-2016, Stéphane Moreau (http://www.logikdev.com)
